...
- (void)makePaymentOrAuthorization
{
    ...
    // check device and credit card availibility
    if ([FDInAppPaymentProcessor canMakePayments])
    {
        if ([FDInAppPaymentProcessor canMakePaymentsUsingNetworks:[TheDemoMerchant soleInstance].supportedNetworks])
        {
            ...
            pmtRqst.countryCode = @"GB";
            // For US pmtRqst.countryCode = @"US";
            // For UK pmtRqst.countryCode = @"GB";
            
           //
            pmtRqst.currencyCode = @"GBP";
            // For US :> pmtRqst.currencyCode = @"USD";
            
            pmtRqst.shippingAddress = [QSROrder theOrder].shipTo;
            
            pmtRqst.merchantCapabilities = FDMerchantCapability3DS;
            //For instore :> pmtRqst.merchantCapabilities =FDMerchantCapability3EMV
           ...
           // merchant Ref
            ...
            //* FD authorization view controller
