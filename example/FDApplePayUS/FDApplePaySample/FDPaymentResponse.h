...
@property (nonatomic, assign) ABRecordRef billingAddress;                    // Billing Address set by user for Apple Pay

@property (nonatomic, assign) ABRecordRef shippingAddress;                    // Shipping Address set by user for Apple Pay
